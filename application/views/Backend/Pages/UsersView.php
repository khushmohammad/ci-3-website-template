        ...
        <div class="container-fluid px-4">
            ...
            <div class="row">
                ...
                <div class="col text-center">
                    <a type="button" class="btn btn-primary float-md-end" href="<?php echo site_url(); ?>admin/AddEdiUser">Add</a>
                </div>
            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table id="UserDatatables" class="table table-striped nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Email</th>
                        ...
                        <tbody>
                            ...
                            foreach ($user as $value) {
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li>
                                        <a id="Edit" class="dropdown-item ButtonId"  href="' . site_url() . 'admin/AddEdiUser/' . $value["U_ID"] . '">Edit</a>
                                    </li>
                                    <li>
                                        <button class="dropdown-item" id="Delete" onclick="DeleteUser(this)"  dataId=' . $value["U_ID"] . ' >Delete</button>
                                    </li>
                                </ul>
                            </div>
                            </td>';
...
<script type="text/javascript">
    ...
    function DeleteUser(e) {
       // console.log(e.attributes.dataid.value, "ee");
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo site_url(); ?>BackendControllers/DashboardController/DeleteUser',
